...
aw_binary = PROJECT_ROOT.joinpath("crowdsec-aws-waf-bouncer")
...
def bouncer_with_lapi(bouncer, crowdsec, aw_cfg_factory, api_key_factory, tmp_path_factory):
    ...
    def closure(config_lapi=None, config_bouncer=None, api_key=None):
        ...
        try:
            ...
            with crowdsec(environment=env) as lapi:
                ...
                with bouncer(aw_binary, cfg) as cb:
                    yield cb, lapi
        finally:
            pass
